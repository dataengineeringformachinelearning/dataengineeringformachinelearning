...
exports.ingestEvent = (0, https_1.onCall)({
    ...
    firebase_functions_1.logger.warn("ingestEvent called after Redpanda cutover", {
        uid: request.auth.uid,
    });
    throw new https_1.HttpsError("failed-precondition", "DEML local event ingest is retired. Send sealed telemetry through the DEML Django API to FORJD.");
});
