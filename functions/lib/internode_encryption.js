...
const authenticatedData = (kid, context, sender, issuedAt, messageId) =>
  Buffer.from(
    [
      ENVELOPE_TYPE,
...
const encryptBytes = (plaintext, context, options = {}) => {
  ...
  const issuedAt =
    (_a = options.issuedAt) !== null && _a !== void 0
      ? _a
...
const encryptKafkaValue = (value, topic) =>
  (0, exports.encryptBytes)(value, `kafka:${topic}`);
