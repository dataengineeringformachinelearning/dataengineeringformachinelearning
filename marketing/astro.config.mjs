...
const vikingUiAccessibilityPatch = {
  name: "deml-viking-ui-accessibility-patch",
  enforce: "pre",
  transform(source, id) {
    const moduleId = id.split("?")[0].replaceAll("\\", "/");
    if (!moduleId.endsWith("/viking-ui/dist/web-components.js")) {
      return null;
    }

    return {
      code: patchVikingSearchPaletteLandmark(source),
      map: null,
    };
  },
};
...
export default defineConfig({
  ...
  vite: {
    ...
    plugins: [vikingUiAccessibilityPatch],
    optimizeDeps: {
      exclude: [
        "@dataengineeringformachinelearning/viking-ui/web-components.js",
      ],
