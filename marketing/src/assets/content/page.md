...
| **Viking-UI Storybook**  | [Vercel](https://vercel.com/) (`ui`)                                              | `ui.dataengineeringformachinelearning.com` — Storybook-only (mirrors `ui.forjd.co`)                                                          |
...
| Viking-UI Storybook            | [Vercel](https://vercel.com/) (`ui`)        | `https://ui.dataengineeringformachinelearning.com` |
...
- `@dataengineeringformachinelearning/viking-ui`: ^9.7.1
